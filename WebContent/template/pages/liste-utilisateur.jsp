            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 <div class="col-sm-8">
						...
						<td><c:out value="${user.poste}" /></td>
						<td>
						
						
						<c:url value="/template/pages/modifier-utilisateur.jsp" var="update_url">
						...
						<c:url value="/template/pages/delete_utilisateur.jsp" var="delete_url">
								<c:param name="id" value="${user.id}" />
						</c:url> 
...
<script type="text/javascript" src="js/comptes.js"> </script>
