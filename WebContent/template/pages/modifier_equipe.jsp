...
<head>
    ...
    <title>Modifier Sous Famille</title>
    <!-- Bootstrap Core CSS -->
...
select * from equipe where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier Equipe</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Modifier Equipe</h3>
                              <c:forEach var="equipe" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" action="update_equipe.jsp" method="POST">
                            <input class="form-control" type="hidden" name="id" value="${equipe.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                          <label>Nom :</label>
                            <input class="form-control" type="text" name="nom" value="<c:out value="${equipe.nom}" />"> </div>
                    </div>
                           
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                          <label>Nombre de Membre :</label>
                            <input class="form-control" type="text" name="nbrmembre" value="<c:out value="${equipe.nbrmembre}" />"> </div>
                    </div>
