...
<head>
    ...
    <title>Liste des Sous Familles</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des Sous Familles</h4> </div>
                ...
                <div class="row">
                 ...
                 <div class="col-sm-8">
						...
						<td><c:out value="${equipe.nbrmembre}" /></td>
						
					<td>
						
							
						
						<c:url value="/template/pages/modifier_equipe.jsp" var="update_url">
								<c:param name="id" value="${equipe.id}" />
						</c:url> 
						...
						<c:url value="/template/pages/delete_equipe.jsp" var="delete_url">
								<c:param name="id" value="${equipe.id}" />
						</c:url> 
