                ...
                <div class="row">
                 ...
                 <div class="col-sm-8">
					...
					<tr>
						...
						<td><c:out value="${projet.datedebut}" /></td>
						<td><c:out value="${projet.deadline}" /></td>
					<td>
						
						<c:url value="/template/pages/liste-tache.jsp" var="update_url">
								<c:param name="id" value="${projet.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
							<label>Tâches</label>	</a>
						
						<c:url value="/template/pages/modifier_projet.jsp" var="update_url">
								<c:param name="id" value="${projet.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_projet.jsp" var="delete_url">
								<c:param name="id" value="${projet.id}" />
						</c:url> 
