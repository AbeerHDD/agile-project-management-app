...
select * from projet where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier Commande</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Modifier Projet</h3>
                              <c:forEach var="projet" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" action="update_projet.jsp" method="POST">
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Nom :</label>
                            <input class="form-control" type="text" name="nom" value="<c:out value="${projet.nom}" />" ></div>
                    </div>
                     <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Description :</label>
                            <input class="form-control" type="text" name="description" value="<c:out value="${projet.description}" />" > </div>
                    </div>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Date Début:</label>
                            <input class="form-control" type="date" name="datedebut" value="<c:out value="${projet.datedebut}" />" > </div>
                    </div>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Date Limite:</label>
                            <input class="form-control" type="date" name="deadline" value="<c:out value="${projet.deadline}" />" > </div>
                    </div>
