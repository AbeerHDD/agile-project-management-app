            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter un Utilisateur</h4> </div>
                ...
                <h5 class="box-title m-t-40 m-b-0">Ajouter un Utilisateur</h5>
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="email" name="login" placeholder="Email"> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <option ></option>
                     <c:forEach var="poste" items="${list1.rows}">
