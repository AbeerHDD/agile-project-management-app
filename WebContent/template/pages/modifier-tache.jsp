...
select * from tache where id = '<c:out value="${param.id}" />' ; 
</sql:query>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier Tâche</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Modifier Tâche</h3>
                            
                              <c:forEach var="tache" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" action="update_tache.jsp" method="POST">
                            <input class="form-control" type="hidden" name="id" value="${tache.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Libillé :</label>
                            <input class="form-control" type="text" name="nom" value="${tache.nom}" > </div>
                    </div>
                               
                              <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Priorité:</label>
                            <input class="form-control" type="text" name="periorite" value="${tache.periorite}"  > </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Difficulté :</label>
                            <input class="form-control" type="text" name="difficulte" value="${tache.difficulte}" > </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Statut :</label>
                            <input class="form-control" type="text" name="statut" value="${tache.statut}" > </div>
                    </div>
                    ...
                    <option >Membre</option>
                     <c:forEach var="membre" items="${list1.rows}">
  ...
  <option value="<c:out value="${membre.nom}"/>" value="<c:out value="${membre.prenom}"/>"><c:out value="${membre.nom}" /> <c:out value="${membre.prenom}" />  </option> 
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="date" name="datedebut" value="<c:out value="${tache.datedebut}" />" > </div>
                    </div>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Date Limite:</label>
                            <input class="form-control" type="date" name="deadline" value="<c:out value="${tache.deadline}" />" > </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Description :</label>
                            <input class="form-control" type="text" name="description" value="${tache.description}" > </div>
                    </div>
                           <div class="form-label-group">
                    <select class="form-control" name="id_projet">
                    <option >Projet</option>
                     <c:forEach var="projet" items="${list2.rows}">
