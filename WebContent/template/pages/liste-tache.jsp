...
select * from tache where id_projet = '<c:out value="${param.id}" />' ; 
</sql:query>
            ...
            <li class="user-pro">
                ...
                <ul class="nav nav-second-level">
                   ...
                   <li><a href="logout.jsp"><i class="fa fa-power-off"></i>  Déconnexion</a></li>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-group"></i><span class="hide-menu"> Equipe <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="liste-equipe.jsp">Liste des Equipes</a> </li>
                            <li> <a href="ajout-equipe.jsp">Ajouter un Equipe</a> </li>
                        </ul>
                    </li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des tâches</h4> </div>
                    <form class="form-material form-horizontal" action="add_tache" method="POST">
                             <input class="form-control" type="hidden" name="id" value="${projet.id}">  
                             </form>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                 ...
                 <div class="col-sm-10">
                        <div class="white-box">
                           <label>Ajouter une nouvelle tâche </label> 
							<a href="ajout-tache.jsp" button type="submit" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Ajouter"><i class="fa fa-plus"></i></button>
						...
						<td><c:out value="${tache.periorite}" /></td>
						<td><c:out value="${tache.difficulte}" /></td>
						<td><c:out value="${tache.statut}" /></td>
						<td><c:out value="${tache.membre}" /></td>
					...
					<td>
						...
						<c:url value="/template/pages/modifier-tache.jsp" var="update_url">
						...
						<c:url value="/template/pages/delete_tache.jsp" var="delete_url">
								<c:param name="id" value="${tache.id}" />
						</c:url> 
