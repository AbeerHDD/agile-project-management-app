            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter un Equipe</h4> </div>
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            <h3 class="box-title">Ajouter un Equipe</h3>
                            <form class="form-material form-horizontal" action="add_equipe.jsp" method="POST">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="nom" placeholder="Nom de l'equipe"> </div>
                    </div>
                               <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="nbrmembre" placeholder="Nombre des membres"> </div>
                    </div>
                                                <br>
