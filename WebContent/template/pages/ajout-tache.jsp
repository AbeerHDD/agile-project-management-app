            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter une tâche</h4> </div>
                 ...
                 <div class="col-sm-8">
                  ...
                  <h5 class="box-title m-t-40 m-b-0">Ajouter une tâche</h5>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="nom" placeholder="Libillé"> </div>
                    </div>
                    <div class="form-label-group">
                    <select class="form-control" name="periorite">
                    
   <option>Périorité</option>                 
