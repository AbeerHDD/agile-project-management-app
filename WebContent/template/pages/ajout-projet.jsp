            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter une Commande</h4> </div>
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="add_projet.jsp" method="POST">
                    ...
                    <div class="form-group m-t-20">
                        ...
                        <label> Date Début : </label>
                            <input class="form-control" type="date" name="datedebut" placeholder="Date"> </div>
                    </div>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label> Date Limite : </label>
                            <input class="form-control" type="date" name="deadline" placeholder="Date"> </div>
                    </div>
