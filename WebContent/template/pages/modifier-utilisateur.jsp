...
select * from user where id = '<c:out value="${param.id}" />' ; 
</sql:query>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier Utilisateur</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="update_utilisateur.jsp" method="POST">
                            <input class="form-control" type="hidden" name="id" value="${user.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Nom :</label>
                            <input class="form-control" type="text" name="nom" value="${user.nom}" > </div>
                    </div>
                               
                              <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Prénom :</label>
                            <input class="form-control" type="text" name="prenom" value="${user.prenom}"  > </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Login:</label>
                            <input class="form-control" type="email" name="login" value="${user.login}" > </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Password:</label>
                            <input class="form-control" type="password" name="password" value="${user.password}" > </div>
                    </div>
                     <div class="form-group ">
                    <label>Poste</label>
                         <select class="form-control" name="poste">
                    <option ></option>
                     <c:forEach var="poste" items="${list2.rows}">
                     
                    
  <option value="<c:out value="${poste.libille}"/>" > <c:out value="${poste.libille}" />  </option> 
 </c:forEach> 
                    ...
                    <option  ></option>
                     <c:forEach var="equipe" items="${list1.rows}">
             <option value="<c:out value="${equipe.id}"/>" ><c:out value="${equipe.nom}" /> </option> 
 </c:forEach> 
